...
/***/ "./src/app/page/bookings/booking.ts":
/*!******************************************!*\
  !*** ./src/app/page/bookings/booking.ts ***!
  \******************************************/
...
/***/ "./src/app/page/bookings/bookings.service.ts":
/*!***************************************************!*\
  !*** ./src/app/page/bookings/bookings.service.ts ***!
  \***************************************************/
...
/* harmony import */ var _booking__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./booking */ "./src/app/page/bookings/booking.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _auth_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth/auth.service */ "./src/app/page/auth/auth.service.ts");
...
var BookingsService = /** @class */ (function () {
    function BookingsService(authService, http) {
        this.authService = authService;
        this.http = http;
        this._bookings = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]([]);
    }
    Object.defineProperty(BookingsService.prototype, "bookings", {
        get: function () {
    ...
    BookingsService.prototype.addBooking = function (booking) {
        ...
        return this.http.post('https://ionic-base-app-7888a.firebaseio.com/bookings.json', __assign({}, booking, { id: null }))
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (b) {
            booking.id = generatedID;
            return _this._bookings.next(b.concat(booking));
        })); // we use tap because we want to run the fn without completing the subs)
    };
    BookingsService.prototype.cancelBooking = function (bookingId) {
        var _this = this;
        return this.http.delete("https://ionic-base-app-7888a.firebaseio.com/bookings/" + bookingId + ".json").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () { return _this.bookings; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (p) {
            var latestBookings = p.filter(function (pl) { return pl.id !== bookingId; });
            _this._bookings.next(latestBookings);
        }));
        return this.bookings.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (p) {
            var latestBookings = p.filter(function (pl) { return pl.id !== bookingId; });
            _this._bookings.next(latestBookings);
        }));
    };
    BookingsService.prototype.fetchBookings = function () {
        var _this = this;
        return this.http.get("https://ionic-base-app-7888a.firebaseio.com/bookings.json?orderBy=\"userId\"&equalTo=\"" + this.authService.userId + "\"")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resData) {
            var bookings = [];
            for (var key in resData) {
                if (resData.hasOwnProperty(key)) {
                    bookings.push(new _booking__WEBPACK_IMPORTED_MODULE_1__["Booking"](key, resData[key].placeId, resData[key].userId, resData[key].placeTitle, resData[key].placeImage, resData[key].firstName, resData[key].lastName, resData[key].guestNumber, new Date(resData[key].bookedFrom), new Date(resData[key].bookedTo)));
                }
            }
...
/***/ "./src/app/page/places/places.service.ts":
/*!***********************************************!*\
  !*** ./src/app/page/places/places.service.ts ***!
  \***********************************************/
...
/* harmony import */ var _auth_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../auth/auth.service */ "./src/app/page/auth/auth.service.ts");
...
var PlacesService = /** @class */ (function () {
    ...
    PlacesService.prototype.fetchPlaces = function () {
        var _this = this;
        return this.http.get('https://ionic-base-app-7888a.firebaseio.com/offered-places.json')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resData) {
            var places = [];
            for (var key in resData) {
                if (resData.hasOwnProperty(key)) {
                    places.push(new _place__WEBPACK_IMPORTED_MODULE_1__["Place"](key, resData[key].title, resData[key].description, resData[key].imageUrl, resData[key].price, new Date(resData[key].availableFrom), new Date(resData[key].availableTo), resData[key].userId));
                }
            }
    ...
    PlacesService.prototype.getPlace = function (id) {
        return this.http.get("https://ionic-base-app-7888a.firebaseio.com/offered-places/" + id + ".json")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resData) { return new _place__WEBPACK_IMPORTED_MODULE_1__["Place"](id, resData.title, resData.description, resData.imageUrl, resData.price, new Date(resData.availableFrom), new Date(resData.availableTo), resData.userId); }));
    ...
    PlacesService.prototype.addPlace = function (place) {
        var _this = this;
        var generatedID; // id that is being saved inside db
        ...
        return this.http.post('https://ionic-base-app-7888a.firebaseio.com/offered-places.json', __assign({}, place, { id: null }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (resData) {
            generatedID = resData.name; // unique id returned from firebase
            return _this.places;
        }), // the http req will return the name observable so we change that return to place observable here
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (p) {
            place.id = generatedID;
            return _this._places.next(p.concat(place));
        })); // we use tap because we want to run the fn without completing the subs);
    };
    ...
    PlacesService.prototype.updateOffer = function (placeId, title, description) {
        var _this = this;
        var updatedPlaces;
        return this.places.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (p) { return !p || p.length <= 0 ? _this.fetchPlaces() : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(p); }), // if the data is not loaded yet fetch the data from the server
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (p) {
            var placeIdx = p.findIndex(function (pl) { return pl.id === placeId; });
            updatedPlaces = p.slice();
            var oldPlace = updatedPlaces[placeIdx];
            updatedPlaces[placeIdx] = new _place__WEBPACK_IMPORTED_MODULE_1__["Place"](oldPlace.id, title, description, oldPlace.imageUrl, oldPlace.price, oldPlace.availableFrom, oldPlace.availableTo, oldPlace.userId);
            _this._places.next(updatedPlaces);
            return _this.http.put("https://ionic-base-app-7888a.firebaseio.com/offered-places/" + placeId + ".json", __assign({}, updatedPlaces[placeIdx], { id: null }));
